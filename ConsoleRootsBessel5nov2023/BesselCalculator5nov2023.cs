...
{
    internal class BesselCalculator5nov2023
    {
...
2.761695824829316e-2, 3.240517192670181e-4 };
        ...
        public double j0(double x)
        {
            ...
            else
            {
                ...
                return Helper5nov2023.sqrt(twoopi / ax) * (Helper5nov2023.cos(xx) * nump / denp - z * Helper5nov2023.sin(xx) * numq / denq);
            }
        }
        ...
        public double j1(double x)
        {
            ...
            else
            {
                ...
                double ans = Helper5nov2023.sqrt(twoopi / ax) * (Helper5nov2023.cos(xx) * nump / denp - z * Helper5nov2023.sin(xx) * numq / denq);
        ...
        double y0(double x)
        {
            if (x < 8.0)
            {
                double j0x = j0(x);
                rat(x, y0r, y0s, 8);
                return nump / denp + twoopi * j0x * Helper5nov2023.log(x);
            }
            else
            {
                ax = x;
                asp(y0pn, y0pd, y0qn, y0qd, 1.0);
                return Helper5nov2023.sqrt(twoopi / x) * (Helper5nov2023.sin(xx) * nump / denp + z * Helper5nov2023.cos(xx) * numq / denq);
            }
        }
        ...
        double y1(double x)
        {
            if (x < 8.0)
            {
                double j1x = j1(x);
                rat(x, y1r, y1s, 7);
                return x * nump / denp + twoopi * (j1x * Helper5nov2023.log(x) - 1.0 / x);
            }
            else
            {
                ax = x;
        ...
        double jn(int n, double x)
        {
            ...
            {
                tox = 2.0 / ax;
                m = 2 * ((n + (int)(Helper5nov2023.sqrt(ACC * n))) / 2);
                jsum = false;
                bjp = ans = sum = 0.0;
                bj = 1.0;
                for (j = m; j > 0; j--)
